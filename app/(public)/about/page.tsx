    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap justify-center gap-5 p-5">
                <Avatar src="/jesse.png" alt="avatar img" name="Jesse" title='PM' linkedinUrl='https://www.linkedin.com/in/jessemoncur/' porfotlioUrl='https://jessemoncur.wixsite.com/jesse-s-moncur'/>
